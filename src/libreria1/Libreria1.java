...
public class Libreria1 {
    ...
    public static void main(String[] args) {
        ...
        editorSv.creaEditorial(edit1);
        editorSv.creaEditorial(edit2);
        editorSv.creaEditorial(edit3);
        editorSv.creaEditorial(edit4);
        editorSv.creaEditorial(edit5);
        editorSv.creaEditorial(edit7);
        editorSv.creaEditorial(edit8);
        editorSv.creaEditorial(edit9);
        editorSv.creaEditorial(edit10);
        editorSv.creaEditorial(edit11);
        editorSv.creaEditorial(edit12);
        editorSv.creaEditorial(edit13);
